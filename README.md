...
- Please see ./ternal/transaction/transaction_handle.go for reference.
...
- In this method, I assign two custom requests. One for transaction retry machanism and one for HTTP request's retry mechanism and other configurations.
...
- *** please provide endpoint in docker-compose
